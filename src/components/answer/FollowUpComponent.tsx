    ...
    return (
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg overflow-hidden mt-4">
            <div className="bg-gradient-to-r from-cyan-500 to-blue-500 p-4">
                <h2 className="text-lg font-semibold text-white">Relevant Questions</h2>
            </div>
                ...
                {followUpQuestions.map((question, index) => (
                    ...
                    >
                        <span
                            role="img"
                            aria-label="link"
                            className="mr-2 text-cyan-500 dark:text-cyan-400"
                        >
                            🔗
                        </span>
                        <p className="flex-1 text-gray-900 dark:text-white">{question}</p>
                    </li>
                ))}
            </ul>
        </div>
